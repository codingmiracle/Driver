...
#define LED_RV		                   0x01		// PB0
#define LED_RH		                   0x02		// PB1
#define LED_LV		                   0x04		// PB2
#define LED_LH		                   0x08		// PB3
...
//    void (*use)(unsigned char);
    ...
    unsigned int (*measure)(unsigned char);
...
// public:
    ...
    void (*setSpeedLeft)(char);
    void (*setSpeedRight)(char);
    void (*stop)(void);
    void (*drive)(char, char, int);
    void  (*turn)(int);
//private:
    volatile unsigned char left;
    volatile unsigned char right;
    volatile int time;
    volatile char isdriving;
//    unsigned char leftC;
//    unsigned char rightC;

    volatile char speedleft;
    volatile char speedright;
};
MOTOR_TYPE motor;
...
// motor.drive(l, r, t);
//-----------------------------------------------------------------------------
// What 4: this function lets the robot drive
// PRE: target == EL_ROBOT
// IN: l, r defines the speed of the two motors, t defines how long the robot drives
// POST: robot drives with a speed of l and r and for a time t
// RETURN: nothing
//-----------------------------------------------------------------------------
